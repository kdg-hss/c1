...
# Simpan data recovery VMess
RECOVERY_DB="/etc/vmess/.vmess.db_recovery"

# Pastikan direktori dan file ada
[ -d "/etc/vmess" ] || mkdir -p /etc/vmess
[ -f "$RECOVERY_DB" ] || touch "$RECOVERY_DB"

# Hapus data lama jika user sama
grep -vwE "^### $user" "$RECOVERY_DB" > /tmp/.temp_vmess_recovery
mv /tmp/.temp_vmess_recovery "$RECOVERY_DB"

# Tambahkan data baru ke recovery
echo "### $user $exp $uuid $iplimit active" >> "$RECOVERY_DB"
clear
...
<code>──────────────────────</code>
<code>Masa Aktif    : $masaaktif Hari</code>
...
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "  Xray/Vmess Account " | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Username       : ${user}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Host           : ${domain}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Limit IP       : ${iplimit} Login" | tee -a /etc/xray/log-create-${user}.log
#echo -e "Limit Quota    : ${Quota} GB" | tee -a /etc/xray/log-create-${user}.log
...
echo -e "Path           : /vmess ~ (/Multipath)" | tee -a /etc/xray/log-create-${user}.log
echo -e "ServiceName    : vmess-grpc" | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Link Websocket TLS      :" | tee -a /etc/xray/log-create-${user}.log
echo -e "${vmesslink1}" | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Link Websocket None TLS : " | tee -a /etc/xray/log-create-${user}.log
echo -e "${vmesslink2}" | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Link Websocket GRPC     : " | tee -a /etc/xray/log-create-${user}.log
...
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "Masa Aktif       : $masaaktif Hari" | tee -a /etc/xray/log-create-${user}.log
echo -e "Berakhir Pada    : $expe" | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
echo -e "        Script By Julak Bantur             " | tee -a /etc/xray/log-create-${user}.log
echo -e "${z}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}" | tee -a /etc/xray/log-create-${user}.log
