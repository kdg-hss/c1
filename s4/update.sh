...
wget -q https://raw.githubusercontent.com/kdg-hss/c1/main/s4/menu.zip -O menu.zip
unzip menu.zip
chmod +x menu/*
...
wget -q https://raw.githubusercontent.com/kdg-hss/c1/main/versionbaru -O /usr/local/sbin/version
